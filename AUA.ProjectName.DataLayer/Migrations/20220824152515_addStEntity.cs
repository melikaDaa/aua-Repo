...
{
    public partial class addStEntity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, 5, 1L, true, false, "Reset Password", "Reset User Password", 0, "Reset Password", null },
                    { 6, 6, 1L, true, true, "Assign access to roles", "Assign access to roles", 0, "User Access Report", null }
                });
